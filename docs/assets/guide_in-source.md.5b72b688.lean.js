import{_ as l,j as p,k as o,V as a,C as s,p as n}from"./chunks/framework.8939a477.js";const C=JSON.parse('{"title":"In-source testing | Guide","description":"","frontmatter":{"title":"In-source testing | Guide"},"headers":[],"relativePath":"guide/in-source.md","filePath":"guide/in-source.md","lastUpdated":1690470465000}'),e={name:"guide/in-source.md"},t=a("",14),c=s("details",{mt4:""},[s("summary",{"text-xl":""},"unbuild"),s("div",{class:"language-diff vp-adaptive-theme"},[s("button",{title:"Copy Code",class:"copy"}),s("span",{class:"lang"},"diff"),s("pre",{class:"shiki vitesse-dark vp-code-dark"},[s("code",null,[s("span",{class:"line"},[s("span",{style:{color:"#DBD7CAEE"}},"// build.config.ts")]),n(`
